...
\else % if luatex or xelatex
  ...
  \setCJKmainfont{YaHei Consolas Hybrid} % 设定中文字型
  \setCJKsansfont{SimSun}
  \setCJKmonofont{SimFang}
  \setmainfont{HelveticaNeueLTStd-LtCn} % 设定英文字型
  \setromanfont{HelveticaNeueLTStd-LtCn} % 字型
  \setmonofont{Monaco}
...
\setkeys{Gin}{width=0.50000\maxwidth,height=0.50000\maxheight,keepaspectratio}
$endif$
$if(links-as-notes)$
