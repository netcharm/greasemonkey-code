...
// @resource       fontawesomeWoff https://cdn.bootcss.com/font-awesome/4.7.0/fonts/fontawesome-webfont.woff?v=4.7.0
// @resource       fontawesome https://cdn.bootcss.com/font-awesome/4.7.0/css/font-awesome.css
...
// @include        https://www.23zw.me/olread/*/*/*.html
...
// @include        https://www.snwx8.com/book/*/*/*.html
// @include        https://www.dhzw.org/book/*/*/*.html
...
var Rule = {
    ...
    nextSelector: "a[rel='next'], a:contains('下一页'), a:contains('下一章'), a:contains('下一节'), a:contains('下页'), a.next-page",
    prevSelector: "a[rel='prev'], a:contains('上一页'), a:contains('上一章'), a:contains('上一节'), a:contains('上页'), a.prev-page",
    // 忽略的下一页链接，匹配 href
    nextUrlIgnore: [
    ...
    indexSelectors: ["a[href='index.html']", "a:contains('返回书目')", "a:contains('章节目录')", "a:contains('章节列表')",
        "a:econtains('最新章节')", "a:contains('回目录')","a:contains('回书目')", "a:contains('目 录')", "a:contains('目录')", "a.index-page"],
...
Rule.specialSite = [
    ...
    {siteName: '起点新版2016',
        ...
        indexSelector: function() {
            return $('div.chapter-control > a:nth-child(3)')[0].href;
            //return location.href.replace(/,.*?\.aspx$/, '.aspx').replace('BookReaderNew', 'BookReader');
        },

        mutationSelector: ".j_readContent",  // 内容生成监视器
            mutationChildCount: 1,
    ...
    {siteName: "123du 小说",
        ...
        titleReg: "(.*)-(.*) (?:百家乐|123读)",
        titlePos: 1,
        contentSelector: "#content, #contents, #haishi",
...
Rule.replace = {
    ...
    // === 重字替换 ===
    "(情qíng)":"情", "(身shēn)":"身", "(阴yīn)":"阴", "(热rè)":"热", "(爱ài)":"爱",
    "[\(|\)]":"", "肉ròu":"肉", "殿diàn":"殿", "逼bī逼":"逼", "操cāocāo":"操",
    "猫咪mī":"猫咪", "荡dàngdàng":"荡", "胸xiōng":"胸", "逼bī":"逼",
    "妓jìjì":"妓", "性xìng":"性", "情qíng":"情", "欲yù":"欲",
    "允yǔn":"允", "身shēn":"身", "奶nǎi":"奶", "射shè":"射",
    ...
    "shàng mén":"上门", "kǎo shì":"考试", "xiāo shòu":"销售", "huó dòng":"活动", 
    "màn huà":"漫画", "zhì fú":"制服", "diàn yǐng":"电影", "dá àn":"答案", 
    "diàn huà":"电话", "zhào piàn":"照片", "ruǎn jiàn":"软件", "露 dòng":"漏洞", 
    "wǔ qì":"武器", "jí pǐn":"极品", "gòng yīng":"供应", "xìng yùn":"幸运", 
    "hé píng":"和平", "mèi mèi":"妹妹", "qiè tīng":"窃听", "sǎo miáo":"扫描",
    "bàn\\s*fǎ":"办法", "bucuo":"不错", "不liáng":"不良", "xiāng zǐ":"箱子",
    "b[ěe]i(\\s|&nbsp;)*j[īi]ng":"北京", "cū kǒu":"粗口", "jǐng chá":"警察",
    "半shen": "半身", "b[ìi]j[ìi]ng":"毕竟", "报(了?)jing":"报$1警", 
    "暧m[eè][iì]":"暧昧", "m[ìi] sh[uū]":"秘书", "疑huo":"疑惑", 
    "包yǎng":"包养", "(?:biǎo|婊\\\\?)子":"婊子", "biǎo\\s*xiàn\\s*":"表现", 
    "chifan":"吃饭", "ch[oō]ngd[oò]ng":"冲动", "chong物":"宠物", "cao(练|作)":"操$1", 
    "出gui":"出轨", "chu\\s*xian":"出现", "缠mian": "缠绵",  "成shu": "成熟", 
    "(?:赤|chi)\\s*lu[oǒ]": "赤裸", "春guang": "春光", "chun风":"春风",  
    "沉mi":"沉迷", "沉lun":"沉沦", "刺ji":"刺激", "chao红":"潮红", "初chun":"初春", 
    "＂ｃｈｉ　ｌｕｏ＂":"赤裸", "dān\\s*xīn":"当心", "dang校": "党校", 
    "da子": "鞑子", "大tui":"大腿", "dǎ\\s*suàn":"打算", "dengdai":"等待", 
    "电huà":"电话", "diao丝": "屌丝", "d[úu](?:\\s|&nbsp;|<br/>)*l[ìi]": "独立", 
    "d[uú]\\s{0,2}c[áa]i":"独裁",  "d?[iì]f[āa]ng":"地方", "d[ìi]\\s*d[ūu]":"帝都", 
    "di国|帝guo":"帝国", "du[oò]落":"堕落", "坠luò":"坠落", "f[ǎa]ngf[óo]":"仿佛", 
    "fei踢": "飞踢", "feng流": "风流", "风liu": "风流", "f[èe]nn[ùu]":"愤怒", 
    "fǎn\\s*yīng":"反应", "gao潮": "高潮", "高氵朝":"高潮", "gāo\\s*xìng\\s*":"高兴", 
    "干chai": "干柴", "勾yin":"勾引", "gu[oò]ch[ée]ng":"过程", "gu[āa]n\\s*x[iì]":"关系", 
    "g[ǎa]nji[àa]o":"感觉", "国wu院":"国务院", "gù\\s*yì\\s*":"故意", "guofen":"过分",
    "hā\\s*hā\\s*":"哈哈", "h[aǎ]ode":"好的", "hù士":"护士", "火qiang":"火枪", 
    "há'guó":"韩国", "han住": "含住", "hai洛因": "海洛因", "红fen": "红粉", 
    "火yao": "火药", "h[ǎa]oxi[àa]ng":"好像", "hu[áa]ngs[èe]":"黄色", 
    "皇d[ìi]":"皇帝", "昏昏yu睡":"昏昏欲睡", "回dang":"回荡", "奸yin":"奸淫", 
    "huí\\s*qù\\s*":"回去", "hé\\s*shì\\s*":"合适", "jian(臣|细)":"奸$1",     
    "jiànmiàn":"见面", "jian货":"贱货", "jing察":"警察", "j[ìi]nháng":"进行", 
    "jīng\\s*guò":"经过", "ji烈":"激烈", "j[iì](nv|女)": "妓女", "jirou": "鸡肉", 
    "ji者":"记者", "jì\\s*xù\\s*":"继续", "ju花":"菊花","j[īi]动":"激动", 
    "jili[èe]":"激烈", "肌r[òo]u":"肌肉","ji射":"激射", "ji[ēe]ch[uù]":"接触", 
    "jiù\\s*shì":"就是", "j[ùu]li[èe]": "剧烈", "jǐng惕": "警惕", "chuang伴":"床伴",
    "节cao":"节操", "浸yin":"浸淫", "jù\\s*jué\\s*":"拒绝", "jue色":"角色",
    "k[ěe]n[ée]ng": "可能", "开bao": "开苞", "k[àa]o近": "靠近", "口wen":"口吻", 
    "kankan":"看看", "ling辱": "凌辱", "luan蛋": "卵蛋", "脸sè": "脸色", 
    "lu出":"露出", "流máng":"流氓", "lun理":"伦理", "lì\\s*qì":"力气", 
    "m[ǎa]ny[ìi]":"满意", "m[ǎa]sh[àa]ng":"马上", "m[ée]iy[oǒ]u":"没有", 
    "mei国": "美国", "m[íi]ngb[áa]i":"明白", "迷huan": "迷幻", "mi茫":"迷茫", 
    "mó\\s*yàng":"模样", "m[íi]n\\s{0,2}zh[ǔu]": "民主", "迷jian": "迷奸", 
    "mimi糊糊":"迷迷糊糊", "末(?:\\s|<br/?>)*ì":"末日", "面se":"面色", 
    "mengmeng":"蒙蒙", "nàme":"那么", "n[ǎa]o\\s*d[àa]i":"脑袋", "chū shòu":"出售",
    "n[ée]ngg[oò]u":"能够", "nán\\s{0,2}hǎi": "那会", "内jian":"内奸", 
    "[内內]y[iī]":"内衣", "内ku":"内裤", "pi[áa]o客":"嫖客", "p[áa]ngbi[āa]n":"旁边",
    "q[íi]gu[àa]i":"奇怪", "qing\\s*(ren|人)":"情人", "qin兽":"禽兽", 
    "q[iī]ngch[uǔ]":"清楚", "què\\s*dìng":"确定", "球mi":"球迷", "青chun":"青春", 
    "青lou":"青楼", "qingkuang":"情况", "fù chóu":"复仇", "q[uú]n ji[āa]o":"群交", 
    "qiang[　\\s]*jian":"强奸", "re\\s*nao":"热闹", "r[úu]gu[oǒ]":"如果", 
    "r[oó]ngy[ìi]":"容易", "ru(房|白色)": "乳$1", "rén员":"人员", "rén形":"人形", 
    "人chao":"人潮",  "renmen":"人名", "上jiang":"上将", "群jiao":"群交", 
    "she(门|术|手|程|击)":"射$1", "sudu":"速度", "shuijue":"睡觉", 
    "shide":"是的", "援jiao":"援交", "乱jiao":"乱交", "rén miàn":"人面",
    "sh[iì]ji[eè]":"世界", "sh[ií]ji[aā]n":"时间", "sh[ií]h[oò]u": "时候", 
    "sh[ií]me":"什么", "si人":"私人", "shi女":"侍女", "shi身": "失身", 
    "lòu dòng":"漏洞", "lu[āa]n ji[āa]o":"乱交", "mi[aà]n j[uù]":"面具",
    "sh[ūu]j[ìi]":"书记", "shu女": "熟女", "shu[　\\s]?xiong":"酥胸", 
    "(?:上|shang)chuang": "上床", "呻y[íi]n": "呻吟", "sh[ēe]ngzh[íi]": "生殖", 
    "深gu": "深谷", "双xiu": "双修", "生r[ìi]": "生日", "si盐":"私盐", 
    "shi卫":"侍卫", "si下":"私下", "sao扰":"骚扰", "ｓｈｕａｎｇ　ｆｅｎｇ":"双峰",
    "t[uū]r[áa]n":"突然", "tiaojiao": "调教", "偷qing":"偷情", "推dao": "推倒", 
    "脱guang": "脱光", "t[èe]bi[ée]":"特别", "t[ōo]nggu[òo]":"通过", 
    "同ju":"同居", "tian来tian去":"舔来舔去", "w[ēe]ixi[ée]":"威胁", 
    "wěi zhuāng":"伪装", "阳w[ěe]i": "阳痿", "you饵": "诱饵", "yu念":"欲念",
    "wèizh[ìi]":"位置", "wei员":"委员", "w[èe]nti":"问题", "wèi\\s*dào\\s*":"味道", 
    "wú\\s*nài":"无奈", "weilai":"未来", "xiu长": "修长", "亵du": "亵渎", 
    "xing福": "幸福", "小bo":"小波", "小niū":"小妞", "xiong([^a-z])":"胸$1", 
    "小tui":"小腿", "xiang港":"香港", "xiàohuà":"笑话", "xiàn\\'zhì":"限制", 
    "xiōng\\s*dì":"兄弟", "选zé":"选择", "yì\\s*wài\\s*":"意外", "射jing":"射精",
    "yin(冷|暗|谋|险|沉|沟|癸派|后)":"阴$1", "y[iī]y[àa]ng":"一样", 
    "y[īi]di[ǎa]n":"一点", "yī\\s*zhèn":"一阵", "y[ǐi]j[īi]ng":"已经", 
    "yí\\s*huò":"疑惑", "影mi":"影迷", "yin荡":"淫荡", "yin贼":"淫贼", 
    "yao头": "摇头", "yaotou": "摇头", "摇tou": "摇头", "yezhan": "野战", 
    "(?:you|诱)(?:惑|huo)": "诱惑", "you导": "诱导", "引you": "引诱", "you人": "诱人", 
    "youshi":"有事", "you\\s*xiu":"优秀", "御yòng":"御用", "旖ni":"旖旎",  
    "you敌深入":"诱敌深入", "影she":"影射", "牙qian":"牙签", "一yè情":"一夜情",
    "z[iì]j[iǐ]": "自己","z[ìi](?:\\s|<br/?>|&nbsp;)*y[oó]u": "自由",
    "zh[iī]d?[àa]u?o":"知道", "zhè\\s*gè":"这个", "中j委":"中纪委", 
    "zixin":"自信", "zhì'fú":"制服", "zha药": "炸药", "zhan有": "占有", 
    "政f[ǔu]|zheng府": "政府", "zh[èe]ng\\s{0,2}f[uǔ]": "政府", "zong理":"总理", 
    "zh[ōo]ngy[āa]ng": "中央", "中yang":"中央", "zu[oǒ]\\s*y[oò]u":"左右", 
    "zhǔ\\s*dòng":"主动", "zh[oō]uw[ée]i":"周围", "中nan海":"中南海", 
    "中zu部":"中组部", "政zhi局":"政治局", "(昨|一|时|余)(?:<br/?>|&nbsp;|\\s)*ì":"$1日", 
    "照she":"照射", "zhǔn\\s*bèi\\s*":"准备", "zhu义":"主义", "yìng bì":"硬币",
    "乃子":"奶子", "yu[aá]n ji[āa]o":"援交", "cí zhí":"辞职", "sh[aā] sh[oǒ]u":"杀手",
    "sh[aā] r[eé]n":"杀人", "sh[eè] xi[aà]ng":"摄像", "chu[aá]n q[ií]":"传奇",
    "g[oō]ng t[óo]u":"公投", "t[uú] pi[aà]n":"图片", "y[iī]ng y[uǔ]":"英语",
    "yǐn xíng":"隐形", "kuáng shè":"狂射", "dǎo dàn":"导弹", "lán jié":"拦截",
    "wēi xíng":"微型", "jiān kòng":"监控", "àn mó":"按摩", "tōu kuī":"偷窥",
    "dài lǐ":"代理", "shì pín":"视频", "hàn jiān":"汉奸", "shǒu qiāng":"手枪",
    "zhuān mài":"专卖", "rì běn":"日本", "bào dòng":"暴动", "měi nǚ":"美女",
    "qì chē":"汽车", "kāi jiǎng":"开奖", "shēn yín":"呻吟", "dú sù":"毒素",
    "téng xùn":"腾讯", "bàn lǐ":"办理", "xiàn jīn":"现金", "chéng rén":"成人",
    "kè lóng":"克隆", "dī jià":"低价", "tào xiàn":"套现 ", "sī wà":"丝袜",
    "zuò bì":"作弊", "zhōu nián":"周年", "hòu mén":"后门", "gou引":"勾引",
    "pī fā":"批发", "huáng sè":"黄色", "diàn gǒu":"电狗", "wài guà":"外挂",
    "gōng nǔ":"弓弩", "guān fāng":"官方", "liú máng":"流氓", "xìn hào":"信号",
    "xià zhù":"下注", "lìng lèi":"另类", "gōng guān":"公关", "qíng rén":"情人",
    "sì jí":"四级", "huì lù":"贿赂", "huǐ róng":"毁容", "měi tuǐ":"美腿", 
    "ròu sè":"肉色", "wén píng":"文凭", "chōu jiǎng":"抽奖", "lún pán":"轮盘",
    "jiān tīng":"监听", "yòu huò":"诱惑", "shǒu kào":"手铐", "jī qíng":"激情",
    "xìng gǎn":"性感", "b[iǐì] shǒu":"匕首", "fǎng zhēn":"仿真", "huǒ yào":"火药",
    "kǒu bào":"口爆", "liè qiāng":"猎枪", "pū kè":"扑克", "jiǎ bì":"假币",
    "dú cì":"毒刺", "lè suǒ":"勒索", "rén pí":"人皮", "dì pǐ":"地痞", "传xiao":"传销",
    "ài rén":"爱人", "niǔ kòu":"纽扣", "荒yin":"荒淫", "wǎ sī":"瓦斯", 
    "sè māo":"色猫", "sè zhàn":"色站", "sè tú":"色图", "jiāo yǒu":"交友",
    "gāo fǎng":"高仿", "dìng gòu":"订购", "sh[aǎà]o fù":"少妇", "fān qiáng":"翻墙",
    "kǎn dāo":"砍刀", "cì dāo":"刺刀", "yǐng dì":"影帝", "tān wū":"贪污",
    "tuō yī":"脱衣", "wěi h[áíia]ng":"尾行", "jǐng gùn":"警棍", "高chao":"高潮",
    "gōng kuǎn":"公款", "guān chǎng":"官场", "bà gōng":"罢工", "xìng fú":"辛福",
...
if (!fontawesomeWoff || fontawesomeWoff.length < 10) {
    fontawesomeWoff = "'http://cdn.bootcss.com/font-awesome/4.7.0/fonts/fontawesome-webfont.woff?v=4.7.0'";
} else if (isChrome) {
...
function addFontAwesome()
{
  ...
  font_css.setAttribute('id', 'FontAwesome');
  ...
  //font_css.setAttribute('href', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
  font_css.setAttribute('href', '//cdn.bootcss.com/font-awesome/4.7.0/css/font-awesome.min.css');
  document.head.appendChild(font_css);
  
  //console.log(GM_getResourceURL('fontawesome'));
  //console.log(GM_getResourceText("fontawesome"));
  //var fat = GM_getResourceText("fontawesome");
  var fat = '@font-face {\n' +
            'font-family: "FontAwesome";\n' +
            'src: url("//cdn.bootcss.com/font-awesome/4.7.0/fonts/fontawesome-webfont.eot?v=4.7.0") !important;\n' +
            'src: url("//cdn.bootcss.com/font-awesome/4.7.0/fonts/fontawesome-webfont.woff?v=4.7.0") !important;\n' +
            'src: url("//cdn.bootcss.com/font-awesome/4.7.0/fonts/fontawesome-webfont.woff2?v=4.7.0") !important;\n' +
            'src: url("//cdn.bootcss.com/font-awesome/4.7.0/fonts/fontawesome-webfont.otf?v=4.7.0") !important;\n' +
            'src: url("//cdn.bootcss.com/font-awesome/4.7.0/fonts/fontawesome-webfont.ttf?v=4.7.0") !important;\n' +
            'src: url("//cdn.bootcss.com/font-awesome/4.7.0/fonts/fontawesome-webfont.svg?v=4.7.0") !important;\n' +
            'font-weight: normal;\n' +
            'font-style: normal;\n' +
            '}';
  //console.log(fat);
...
function fixContentType()
{
    ...
    //document.head.insertBefore(element, document.getElementsByTagName('meta')[0]);
